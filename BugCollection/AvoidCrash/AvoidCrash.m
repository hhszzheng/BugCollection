...
+ (void)noteErrorWithException:(NSException *)exception defaultToDo:(NSString *)defaultToDo {
    ...
    for (NSString *str in callStackSymbolsArr) {
    ...
    NSString *logErrorMessage = [NSString stringWithFormat:@"\n\n%@\n\n\n%@\n%@\n%@\n%@\n%@\n\n%@\n\n\n\n%@\n\n",AvoidCrashSeparatorWithFlag,dateStr, errorName, errorReason, errorPlace, defaultToDo,strSymbols ,AvoidCrashSeparator];
    ...
    if (![fileManager fileExistsAtPath:logFilePath]) {
        [logErrorMessage writeToFile:logFilePath atomically:YES encoding:NSUTF8StringEncoding error:nil];
    }else{
        NSFileHandle *outFile = [NSFileHandle fileHandleForWritingAtPath:logFilePath];
        [outFile seekToEndOfFile];
        [outFile writeData:[logErrorMessage dataUsingEncoding:NSUTF8StringEncoding]];
        [outFile closeFile];
    }
